...
// Schéma AppareilPret (copié du modèle)
const appareilPretSchema = new mongoose.Schema({
  ...
  photo: String,
  accessoiresInclus: [String],
  conditionsPret: String,
...
const AppareilPret = mongoose.model('AppareilPret', appareilPretSchema);
...
async function importAppareilsPret() {
  try {
    ...
    if (!fs.existsSync(csvPath)) {
      console.error('❌ Fichier appareils-pret.csv introuvable');
